...
<div class="container">
	<div class="row">
		<div class="col-lg-12">
			<h2 class="pageTitle">Registrar Permisos y Reposos</h2>
		</div>
	</div>
</div>
</section>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				@if(session('estado')=="realizado")
					<div class="alert alert-success alert-dismissable">
						...
						<strong>Muy Bien!</strong> El permiso o reposo se ha registrado con exito!.
					</div>
				@else
	...
	@endif
		...
		<div class="row">
			<div class="contact-form">
				<form id="contact-form" role="form" novalidate="novalidate" method="post" action="">
					<div class="row">
						...
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
							<div class="form-group has-feedback">
								...
								<input type="date" class="form-control" id="startdate" name="startdate" min={{date('dmY')}} onKeyUp = "this.value=formateafecha(this.value);" required>
						...
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
							<div class="form-group has-feedback">
								...
								<input type="date" class="form-control" id="enddate" name="enddate"  min={{date('dmY')}} onKeyUp = "this.value=formateafecha(this.value);" required>
								<i class="fa fa-navicon form-control-feedback"></i>
							</div>
						</div>
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
							<div class="form-group has-feedback">
								...
								<textarea class="form-control" rows="6" id="details" name="details" style="resize:none"  required></textarea>
